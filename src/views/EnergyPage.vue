<template>
  <div class="relative">
    ...
    <div class="space-y-20 lg:pl-20">
      ...
      <section id="data-hub" class="text-center p-8 bg-green-50 dark:bg-green-900/20 rounded-2xl">
        <h3 class="text-2xl font-bold text-gray-800 dark:text-gray-100">See the Full Breakdown</h3>
        <router-link to="/dashboard/energy-climate-change" class="mt-6 inline-flex items-center gap-x-2 bg-green-600 text-white font-bold py-3 px-6 rounded-lg hover:bg-green-700 transition-transform hover:scale-105">
