<template>
  <div class="pb-4 mb-6 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
    ...
    <button @click="$emit('toggle-dark-mode')" class="p-2 rounded-full bg-gray-200 dark:bg-gray-800 text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 dark:focus:ring-offset-gray-900">
